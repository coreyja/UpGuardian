      ...
      <body class="h-full">
          <div>
                          ...
                          <ul class="flex flex-1 flex-col gap-y-7" role="list">
                              <li>
                                  <ul class="-mx-2 space-y-1" role="list">
                                      <li>
                                          <a
                                              class="text-indigo-200 hover:text-white hover:bg-indigo-700 group rounded-md p-2 block flex gap-x-3"
                                              href="/"
                                          >
                                              <i
                                                  class="self-center shrink-0 text-white fa-fw fa-solid fa-house"
                                                  aria-hidden="true"
                                              ></i>
                                      ...
                                      <li>
                                          ...
                                          >
                                              <i
                                                  class="self-center shrink-0 text-white fa-fw fa-solid fa-globe"
                                                  aria-hidden="true"
                                              ></i>
                                              <span class="text-sm leading-6 font-semibold">Sites</span>
                                          </a>
                                      </li>
                                  </ul>
                              </li>
                              <li>
                                  ...
                                  <ul class="-mx-2 space-y-1" role="list">
                                      <li>
                                          <a
                                              class="text-indigo-200 hover:text-white hover:bg-indigo-700 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold"
                                              href="/my/sites/571dea73-1bbd-427a-a0df-315d1f41c928"
                                          >
                                              <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border border-indigo-400 bg-indigo-500 text-[0.625rem] font-medium text-white">
                                                  c
                                              </span>
                                              <span class="truncate">coreyja</span>
                                          </a>
                                      </li>
                                      <li>
                                          <a
                                              class="text-indigo-200 hover:text-white hover:bg-indigo-700 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold"
                                              href="/my/sites/84a63bde-e453-4b68-bac6-66fd0b3883ff"
                                          >
                                              <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border border-indigo-400 bg-indigo-500 text-[0.625rem] font-medium text-white">
                                                  s
                                              </span>
              ...
              <div class="sticky top-0 z-40 flex items-center gap-x-6 bg-indigo-600 px-4 py-4 shadow-sm sm:px-6 lg:hidden">
                  <button class="-m-2.5 p-2.5 text-indigo-200 lg:hidden" type="button">
